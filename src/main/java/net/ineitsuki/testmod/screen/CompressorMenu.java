...
public class CompressorMenu extends AbstractContainerMenu {
    ...
    public CompressorMenu(int id, Inventory inv, BlockEntity entity, ContainerData data) {
        ...
        this.blockEntity.getCapability(ForgeCapabilities.ITEM_HANDLER).ifPresent(handler -> {
            this.addSlot(new SlotItemHandler(handler, 0, 14, 20));
            this.addSlot(new SlotItemHandler(handler, 1, 33, 20));
            this.addSlot(new SlotItemHandler(handler, 2, 52, 20));
            this.addSlot(new SlotItemHandler(handler, 3, 14, 39));
            this.addSlot(new SlotItemHandler(handler, 4, 33, 39));
            this.addSlot(new SlotItemHandler(handler, 5, 52, 39));
            this.addSlot(new SlotItemHandler(handler, 6, 14, 58));
            this.addSlot(new SlotItemHandler(handler, 7, 33, 58));
            this.addSlot(new SlotItemHandler(handler, 8, 52, 58));
            this.addSlot(new SlotItemHandler(handler, 9, 128, 38));
        });
